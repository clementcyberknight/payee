...
import { Download, MoreHorizontal, ArrowLeft, ArrowRight } from "lucide-react";
    ...
    <div className="bg-white rounded-tl-xl shadow-md p-6 w-full">
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex flex-col items-end gap-2">
          {" "}
          <button className="bg-[#1552a7] rounded-md text-white font-semibold py-2 px-4 focus:outline-none focus:shadow-outline">
            Wallet
          </button>
          <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline flex items-center gap-2 shadow-sm">
            <Download size={16} />
            Export CSV
          </button>
        </div>
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex items-center space-x-2">
          <button
            className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2 px-3 rounded-md focus:outline-none focus:shadow-outline disabled:opacity-50"
            disabled
          >
            <ArrowLeft size={16} />
          </button>
          <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2 px-3 rounded-md focus:outline-none focus:shadow-outline disabled:opacity-50">
            <ArrowRight size={16} />
          </button>
        </div>
      </div>
